...
void canvas::deselect_all()
{
	...
	for (unsigned int i = 0; i < activ_cells.size(); i++)
	{
		for (unsigned int j = 0; j < activ_cells[0].size(); j++)
		{
...
void canvas::save_to(std::string file_name)
{
	...
	for (unsigned int i = 0; i < cell_letters.size(); i++)
	{
		for (unsigned int j = 0; j < cell_letters[0].size(); j++)
		{
